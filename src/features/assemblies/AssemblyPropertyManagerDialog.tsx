...
import type { Assembly, MaterialProperty } from "@/types/domain";
import { useAppStore } from "@/lib/store";
import { Plus, Trash2 } from "lucide-react";
import { v4 as uuidv4 } from "uuid";

interface AssemblyPropertyManagerDialogProps {
    open: boolean;
...
export function AssemblyPropertyManagerDialog({ open, onOpenChange, assembly, initialSpecificationId }: AssemblyPropertyManagerDialogProps) {
    const { updateAssembly, properties, fetchProperties, specifications } = useAppStore();
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    <DialogTitle>Manage Assembly Properties</DialogTitle>
                    <DialogDescription>
                        Assign properties defined in the global registry to this assembly.
                    </DialogDescription>
                </DialogHeader>
