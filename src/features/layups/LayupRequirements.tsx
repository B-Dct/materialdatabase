...
export function LayupRequirements({ layup }: LayupRequirementsProps) {
    const { requirementProfiles, updateLayup } = useAppStore();
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    {layup.assignedProfileIds?.map(pid => {
                        ...
                        return (
                            <div key={pid} className="flex items-center justify-between border p-3 rounded-md bg-card hover:bg-muted/10 transition-colors">
